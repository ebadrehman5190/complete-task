<?php
                ...
                $diff_member=implode(',',$_POST['diff_member']);
                $diff_amount=implode(',',$_POST['diff_amount']);

                foreach ($_POST['diff_member'] as $key => $value1) {
                    ...
                    //echo "UPDATE costumer SET costumer_balance = '".$balance1['costumer_balance'] + $_POST['diff_amount'][$key]."' 
                    //                 WHERE costumer_user = '".$value1."' ";
                    //  die; 
                    
                    if(empty($balance1['costumer_balance'])){
                        $m_insert = "UPDATE costumer SET costumer_balance = '".$_POST['diff_amount'][$key]."'
                                     WHERE costumer_user = '".$value1."' ";
                        ...
                        $add1 = $balance1['costumer_balance'] + $_POST['diff_amount'][$key];
                    ...
                    $new = "INSERT INTO Lunch_system ( date, members, items, paid, amount, per_head, unselected_member, unselected_amount)
                            VALUES ('".$_POST['date']."', '".$select."', '".$items."', '".$_POST['paid']."', '".$_POST['amount']."', '".$_POST['per_head']."', '".$diff_member."', '".$diff_amount."' )";
